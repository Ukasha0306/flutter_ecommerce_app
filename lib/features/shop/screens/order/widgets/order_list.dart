              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text('Processing', style: Theme.of(context).textTheme.bodyLarge!.apply(color: TColors.primary, fontSizeDelta: 1),),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('[#32564]', style: Theme.of(context).textTheme.titleMedium),
                          ],
                        ),
                      ),
                    ],
